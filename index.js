...
<body>
  ...
  <p> <a href="https://github.com/crazypeace/Url-Shorten-Worker/" target="_self">by crazypeace</a> </p>
</body>
</html>`
...
async function handleRequest(request) {
  ...
  if (path==password_value){  
    let index= await fetch("https://github.com/hughiehao/Url-Shorten-Worker/raw/main/"+config.theme+"/index.html")
  ...
  if (location) {
    if (config.no_ref=="on"){
      let no_ref= await fetch("https://github.com/hughiehao/Url-Shorten-Worker/raw/main/no-ref.html")
